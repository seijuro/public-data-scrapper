...
import com.github.seijuro.publicdata.result.TheUseOfGasAPIResult;
import com.github.seijuro.publicdata.result.item.TheUseOfGasData;

import java.util.ArrayList;
import java.util.List;

public class TheUseOfGasAPIResponseParser extends PublicDataAPIResponseXMLParser {
    /**
     * Instance Properties
     */
    protected TheUseOfGasData.Builder dataBuilder = null;
    protected List<TheUseOfGasData> dataList = null;

    /**
     * Construct <code>InsuranceAPIResponseParser</code> instance.
     */
    public TheUseOfGasAPIResponseParser() {
    ...
    protected boolean handleTagBegin(String tag) {
        if (!super.handleTagBegin(tag)) {
            if (TheUseOfEnergyPropertyUtils.Item.contains(tag)) {
                ...
                dataBuilder = new TheUseOfGasData.Builder();
    ...
    protected PublicDataAPIResult createResult() {
        if (!hasError()) {
            PublicDataAPIResult result = new TheUseOfGasAPIResult(super.createResult());
